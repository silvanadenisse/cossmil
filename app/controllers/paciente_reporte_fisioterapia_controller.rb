class PacienteReporteFisioterapiaController < ApplicationController
  ...
  def paciente_reporte_fisioterapium_params
    params.require(:paciente_reporte_fisioterapium).permit(:paciente_id, :fecha_consulta, :parte_fisioterapium_id, :num_sesion, :diagnostico, :procedencia, :tipo_consulta, :tipo_asegurado, :edad)
  end
end
