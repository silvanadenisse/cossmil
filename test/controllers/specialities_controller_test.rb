...
class SpecialitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create speciality" do
    assert_difference('Speciality.count') do
      post specialities_url, params: { speciality: { area_id: @speciality.area_id, nombre: @speciality.nombre } }
    end
  ...
  test "should update speciality" do
    patch speciality_url(@speciality), params: { speciality: { area_id: @speciality.area_id, nombre: @speciality.nombre } }
