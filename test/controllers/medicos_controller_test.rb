...
class MedicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medico" do
    assert_difference('Medico.count') do
      post medicos_url, params: { medico: { apellido: @medico.apellido, carnet: @medico.carnet, nombre: @medico.nombre } }
    end
  ...
  test "should update medico" do
    patch medico_url(@medico), params: { medico: { apellido: @medico.apellido, carnet: @medico.carnet, nombre: @medico.nombre } }
